...
url = "postgres://test:password@example.com:5432/db_one"
...
def test_dump_file_name_with_timestamp():
    ...
    """
    timestamp = "2020-10-03T12:34:10"
    assert pgdump.dump_file_name(url, timestamp) == "db_one-2020-10-03T12:34:10.sql"
